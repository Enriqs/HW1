...
# Changes
 Few changes were made, in HTML.

 Fixed redirectioning when Search Enginge Optimization was clicked, adding an id in line 29.
 
 Alt attribute was added to each image, in case it doesn't load.
 
 Now headers are in sequential order from h1 to h4.
 
 In CSS 

 In header display:flex was added and float:right was eliminated, to make the webpage more accessible.

 In footer h2 was edited into h4, to give it more order sequence.

 Tried to change the float elements in the rest of the page to make it more accessible, but issues were found and I rather decided to let it as it is.
